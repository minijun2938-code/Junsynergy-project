...
def analyze_compatibility_with_meta(data_a, data_b, name_a, name_b, mode="colleague", additional_info=None):
    ...
    try:
        ...
        meta = {"model": model_name, "system_prompt": system_prompt, "user_prompt": user_content}
        return report, meta
...
def analyze_team_synergy_with_meta(team_members, team_name, leader_name):
    ...
    try:
        ...
        report = resp.choices[0].message.content
        meta = {"model": model_name, "system_prompt": system_prompt, "user_prompt": ""}
        return report, meta
...
def analyze_compatibility(data_a, data_b, name_a, name_b, mode="colleague", additional_info=None):
    report, _ = analyze_compatibility_with_meta(data_a, data_b, name_a, name_b, mode=mode, additional_info=additional_info)
    return report


def analyze_team_synergy(team_members, team_name, leader_name):
    report, _ = analyze_team_synergy_with_meta(team_members, team_name, leader_name)
    return report
